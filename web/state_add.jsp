...
<head>
    ...
    <%
        String train = String.valueOf(request.getAttribute("train"));
...
<div class="row">
    ...
    <div class="rightcolumn">
        <div class="card">
            ...
            <form class="form" action="State_add">
                <table  align="center" cellspacing="10px">
                    <td><input type="hidden" name="id" value=<%=train%>></td>
                    <td><input type="hidden" name="state_id" value=<%=id%>></td>
                    <tr><td>Cost:</td><td><input type="number" name="cost"></td></tr>
                    <tr><td>State_name:</td><td><input type="text" name="name"></td></tr>
                    <tr><td>State_time:</td><td><input type="text" name="time"></td></tr>
                </table>
                <table align="center" cellspacing="10px">
                    <tr>
                        <td><input type="submit" value="Submit"  ></td>
                        <td><input type="button" value="Finish" onclick="Finish()" ></td>
                    </tr>
                </table>
            </form>
        </div>
