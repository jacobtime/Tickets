...
<head>
    ...
    <script type="text/javascript">
        ...
        function train() {
            window.location.href = "train_management.jsp";
        }
        function state() {
            window.location.href = "state_management.jsp";
        }
        function user() {
    ...
    <%
        ...
        try {
            orderList = Global_var.getAllOrder();
...
<div class="row">
    ...
    <div class="rightcolumn">
        <div class="card">
            ...
            <form class="form" name="management">
                ...
                <table  align="center" cellspacing="20px">
                    <tr>
                        <td><input type="button" value="manage train" onclick="train()"></td>
                        <td><input type="button" value="manage state" onclick="state()"></td>
                        <td><input type="button" value="manage user"onclick="user()"></td>
                    </tr>
                </table>
            </form>
        </div>
