    ...
    <div class="rightcolumn">
        <div class="card">
            ...
            <form action="Register" method="post">
                <table style=" border-spacing: 0px 10px" align="center">
                    <tr align="center">
                        <td >Username：</td>
                    ...
                    <tr align="center">
                        <td> Sex：</td>
                        <td><input type="radio" name="sex" value="man">Man</td>
                        <td><input type="radio" name="sex" value="woman">Woman</td>
                    </tr>
                    <tr align="center">
                        <td> ID card：</td>
                ...
                <table style="border-spacing: 50px 10px;" align="center">
                    <tr align="center">
                        <td><input type="submit" value="Register" method="post"></td>
                    </tr>
                </table>
            </form>
        </div>
